...
<table class="w-100" style="margin-top: -45px">
    <tr class="w-100">
        ...
        <td class="w-50">
            ...
            <h4 class="font-9" style="margin-left:100px;  margin-top:-93px">Nassau University Medical Center <br>
                - Department of Public Safety <br>
                -2201 Hempstead Turnpike <br>
    ...
    <tr class="w-100">
        <td class="w-50">
            <p class="font-15" style="margin-top:-50px;">Date : @if (!empty($blotters))
                    {{ \Carbon\Carbon::parse($blotters->tour_date)->format('m/d/Y') }}
                @endif
            </p>
        </td>
    </tr>
    <tr class="w-100">
        <td class="w-50">
            <p class="font-15" style="margin-top : -35px;">Tour : @if (!empty($blotters))
                    {{ $blotters->tour_name }}
                @endif
            </p>
        </td>
    ...
    <tr class="w-100">
        <td class="w-50">
            <p class="font-15" style="margin-top : -22px;">Tour Commander : @if (!empty($blotters->tour_commander))
                    {{ $blotters->tour_commander->name }}
                @endif
            </p>
        </td>
    </tr>
    <tr class="w-100">
        <td class="w-50">
            <p class="font-15" style="margin-top : -22px;">Supervisor : @if (!empty($blotters->supervisor))
                    {{ $blotters->supervisor->name }}
                @endif
            </p>
        </td>
    </tr>
...
<table style="margin-top: -25px">
    <tr class="w-100">
        <td class="w-50">
            <p class="font-15" style="margin-top : -13px;">Weather: @if (!empty($blotters))
                    {{ $blotters->weather }}
                @endif
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            </p>
        ...
        <td class="w-50">
            <p class="font-15">Road Conditions: @if (!empty($blotters))
                    {{ $blotters->road_condition }}
                @endif
            </p>
        </td>
    </tr>
...
<table style="margin-top: -20px">
    <tr class="w-100">
        <td class="w-50">
            <input type="checkbox" @if (!empty($blotters) && $blotters->fob_1 == 'Fob 1') checked @endif />
        </td>
        <td class="w-50">
            <span>Fob 1</span>
        </td>
        <td class="w-50">
            <input type="checkbox" @if (!empty($blotters) && $blotters->fob_2 == 'Fob 2') checked @endif />
        </td>
        <td class="w-50">
            <span>Fob 2</span>
        </td>
    ...
    <tr class="w-100">
        <td class="w-50">
            <input type="checkbox" @if (!empty($blotters) && $blotters->fob_3 == 'Fob 3') checked @endif />
        </td>
        <td class="w-50">
            <span>Fob 3</span>
        </td>
        <td class="w-50">
            <input type="checkbox" @if (!empty($blotters) && $blotters->fob_4 == 'Fob 4') checked @endif />
        </td>
        <td class="w-50">
            <span>Fob 4</span>
        </td>
...
<table>
    <tr class="w-100">
        <td class="w-50" style="margin-top: -30px">
            <p>Other Information: <br>@if (!empty($blotters))
                {{ $blotters->comment }}
            @endif</p>
        </td>
    </tr>
